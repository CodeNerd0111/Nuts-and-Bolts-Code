...
class MyRobot(wpilib.TimedRobot):
    def robotInit(self):
        ...
        # Add the ultrasonic to the "Sensors" tab of the dashboard - Not necessary to function btw
    ...
    def teleopPeriodic(self):
        ...
        SmartDashboard.putNumber("Turn Motor Value", turnVal)
        SmartDashboard.putNumber("Actual Turning Speed (Deg/s)", self.gyro.getRate)
        SmartDashboard.putNumber("Forward Acceleration (G's)", self.gyro.getRawAccelY)
